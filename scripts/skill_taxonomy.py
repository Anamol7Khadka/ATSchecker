...
TAXONOMY: Dict[str, SkillInfo] = {
    ...
    "requirements engineering": SkillInfo("Requirements Engineering",
        aliases=["requirements management", "anforderungsmanagement", "anforderungsingenieur"],
        category="systems_engineering", related=["doors", "traceability", "sysml"]),
    "systems engineering": SkillInfo("Systems Engineering",
        aliases=["system engineering", "systemtechnik", "systemingenieur"],
        category="systems_engineering", related=["mbse", "v-model", "requirements engineering"]),
    "sysml": SkillInfo("SysML", aliases=["systems modeling language", "sysml v2", "sysml v1.6"],
        category="systems_engineering", parent="mbse", related=["uml", "enterprise architect"]),
    "mbse": SkillInfo("MBSE",
        aliases=["model based systems engineering", "modellbasierte systementwicklung",
                 "model-based systems engineering"],
        category="systems_engineering", related=["sysml", "systems engineering"]),
    "doors": SkillInfo("IBM DOORS",
        aliases=["doors", "doors ng", "ibm doors ng", "ibm dng", "doors next generation"],
        category="tool", related=["requirements engineering", "traceability"]),
    "enterprise architect": SkillInfo("Enterprise Architect",
        aliases=["sparx ea", "sparx enterprise architect", "sparx"],
        category="tool", related=["sysml", "uml"]),
    "ibm rational rhapsody": SkillInfo("IBM Rational Rhapsody",
        aliases=["rhapsody", "rational rhapsody"],
        category="tool", related=["sysml", "mbse"]),
    "v-model": SkillInfo("V-Model",
        aliases=["v-modell", "v model", "v-modell xt", "vee model"],
        category="methodology", related=["systems engineering", "system testing"]),
    "iso 26262": SkillInfo("ISO 26262",
        aliases=["functional safety", "funktionale sicherheit", "fusi", "iso26262"],
        category="standard", related=["aspice", "automotive"]),
    "aspice": SkillInfo("ASPICE",
        aliases=["automotive spice", "a-spice"],
        category="standard", related=["automotive", "iso 26262"]),
    "do-178c": SkillInfo("DO-178C",
        aliases=["do178c", "do-178b", "do178b"],
        category="standard", related=["aerospace", "functional safety"]),
    "iec 61508": SkillInfo("IEC 61508",
        aliases=["iec61508"],
        category="standard", related=["functional safety"]),
    "traceability": SkillInfo("Traceability",
        aliases=["rückverfolgbarkeit", "anforderungsverfolgung", "requirements traceability"],
        category="concept", related=["requirements engineering", "doors"]),
    "system testing": SkillInfo("System Testing",
        aliases=["systemtest", "integration testing", "systemintegration"],
        category="concept", related=["v-model", "verification"]),
    "lemon tree": SkillInfo("Lemon Tree", aliases=["lemontree"],
        category="tool", related=["sysml", "model diffing", "enterprise architect"]),
    "smartfacts": SkillInfo("Smartfacts", aliases=[],
        category="tool", related=["requirements engineering"]),
    "uml": SkillInfo("UML", aliases=["unified modeling language"],
        category="systems_engineering", related=["sysml", "enterprise architect"]),
    "fmea": SkillInfo("FMEA",
        aliases=["failure mode and effects analysis", "fehlermöglichkeits- und einflussanalyse"],
        category="concept", related=["iso 26262", "functional safety"]),
    "fta": SkillInfo("FTA",
        aliases=["fault tree analysis", "fehlerbaumanalyse"],
        category="concept", related=["functional safety", "fmea"]),
}
